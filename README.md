...
<p align="center">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="./assets/switching_to_html_dark.gif">
    <source media="(prefers-color-scheme: light)" srcset="./assets/switching_to_html_light.gif">
    <img alt="Switching to HTML showcase" src="./assets/switching_to_html_light.gif" width="95%">
  </picture>
</p>
