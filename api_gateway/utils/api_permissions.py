...
PERMISSIONS_TABLE = {
    ...
    "users_all": {"GET": MAINTAINER_PERMISSION, "DELETE": MAINTAINER_PERMISSION},
    "users_role": {"PUT": MAINTAINER_PERMISSION},
    "sessions": {
        "POST": PUBLIC_PERMISSION,
    ...
    "sessions_all": {"GET": MAINTAINER_PERMISSION, "DELETE": MAINTAINER_PERMISSION},
    "questions": {
    ...
    "questions_all": {"GET": USER_PERMISSION, "DELETE": MAINTAINER_PERMISSION},
}
